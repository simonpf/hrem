...
class HREMDataset0(Dataset):
    """
    Dataset to load version X.0 of the input data, which containing three input features:
...
class HREMDataset1(Dataset):
    """
    Dataset to load version X.1 of the input data, which containing three input features:
...
class HREMDataset2(Dataset):
    """
    Dataset to load version X.2 of the input data, which containing three input features:
